...
export default function ServerStatusBanner(): React.ReactElement | null {
  ...
  return (
    <div
      className="fixed top-4 left-1/2 z-50 -translate-x-1/2 rounded-lg border border-amber-500/30 bg-[#3d3524] px-4 py-2 shadow-lg"
    ...
    >
      <div className="flex items-center justify-between gap-3">
        ...
        <button
          ...
          onClick={handleRetry}
          disabled={retrying}
          className="shrink-0 rounded border border-amber-500/40 px-2 py-1 text-xs text-amber-200 hover:bg-amber-500/10 disabled:opacity-50"
        >
