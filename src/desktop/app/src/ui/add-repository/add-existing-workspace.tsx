...
interface IAddExistingWorkspaceProps {
...
interface IAddExistingWorkspaceState {
  readonly path: string
...
export class AddExistingWorkspace extends React.Component<
  IAddExistingWorkspaceProps,
  IAddExistingWorkspaceState
> {
  public constructor(props: IAddExistingWorkspaceProps) {
    super(props)
  ...
  private renderErrors() {
    ...
    return (
      <Row>
        <InputError
          id="add-existing-workspace-path-error"
  ...
  public render() {
    ...
    return (
      <Dialog
        id="add-existing-workspace"
        title={__DARWIN__ ? 'Add Local Workspace' : 'Add local workspace'}
      ...
      >
        <DialogContent>
          <Row>
            <TextBox
              ...
              ariaDescribedBy="add-existing-workspace-path-error"
            />
        ...
        <DialogFooter>
          <OkCancelButtonGroup
            okButtonText={__DARWIN__ ? 'Add Workspace' : 'Add workspace'}
  ...
  private addRepository = async () => {
    ...
    if (repositories.length > 0) {
      ...
      dispatcher.recordAddExistingWorkspace()
    }
  }
