...
import { AddExistingWorkspace, CreateRepository } from './add-repository'
...
export class App extends React.Component<IAppProps, IAppState> {
  ...
  private showAddLocalRepo = () => {
    return this.props.dispatcher.showPopup({ type: PopupType.AddWorkspace })
  }
  ...
  private popupContent(popup: Popup, isTopMost: boolean): JSX.Element | null {
    ...
    switch (popup.type) {
      ...
      case PopupType.AddWorkspace:
        return (
          <AddExistingWorkspace
            key="add-existing-workspace"
            onDismissed={onPopupDismissedFn}
            dispatcher={this.props.dispatcher}
            path={popup.path}
          />
