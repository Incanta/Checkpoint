...
> {
      ...
      <UiView id="no-repositories">
        <section aria-label="Let's get started!">
          <header>
            ...
            <p>
              Download a repository to a local workspace to start collaborating
            </p>
          </header>
  ...
  private onShowDownload = () => this.props.onClone()
  ...
  private renderDownloadButton() {
    return this.renderButtonGroupButton(
      ...
      __DARWIN__
        ? 'Download an Existing Repository from the Checkpoint server to a new local workspace…'
        : 'Download an existing repository from the Checkpoint server to a new local workspace…',
      this.onShowDownload,
      undefined,
      !this.isUserSignedIn()
  ...
  private renderCreateRepositoryButton() {
    return this.renderButtonGroupButton(
      OcticonSymbol.plus,
      __DARWIN__
        ? 'Create a New Repository on the Checkpoint server…'
        : 'Create a new repository on the Checkpoint server…',
      this.props.onCreate
    )
  }
  ...
  private renderAddExistingRepositoryButton() {
    return this.renderButtonGroupButton(
      ...
      __DARWIN__
        ? 'Add an Existing Workspace from your Hard Drive…'
        : 'Add an existing workspace from your hard drive…',
      this.props.onAdd
    )
  }
