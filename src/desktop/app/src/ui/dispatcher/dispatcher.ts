...
export class Dispatcher {
   ...
   */
  public beginOfficialSignIn(): Promise<void> {
    return this.appStore._beginOfficialSignIn()
  }
   ...
   * this promise will never complete.
   */
  public async requestBrowserAuthenticationToOfficial(): Promise<void> {
    await this.beginOfficialSignIn()
   ...
   * GitHub.com.
   */
  public async showOfficialSignInDialog(): Promise<void> {
    await this.appStore._beginOfficialSignIn()
    ...
    switch (action.name) {
      ...
      case 'open-repository-from-path':
        ...
        if (existingRepository) {
          ...
          this.statsStore.recordAddExistingWorkspace()
        } else {
          await this.showPopup({ type: PopupType.AddWorkspace, path })
        }
        break
  ...
  public recordAddExistingWorkspace() {
    this.statsStore.recordAddExistingWorkspace()
  }
