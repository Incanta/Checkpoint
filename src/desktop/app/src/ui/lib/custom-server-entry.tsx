...
interface ICustomServerEntryProps {
  /**
...
interface ICustomServerEntryState {
  readonly serverAddress: string
}

/** An entry form for a custom address. */
export class CustomServerEntry extends React.Component<
  ICustomServerEntryProps,
  ICustomServerEntryState
> {
  public constructor(props: ICustomServerEntryProps) {
    super(props)
  ...
  public render() {
    ...
    return (
      <Form onSubmit={this.onSubmit}>
        <TextBox
          label="Checkpoint instance address"
          autoFocus={true}
