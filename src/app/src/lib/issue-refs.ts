// MIRROR: canonical source is src/core/common/src/utils/issue-refs.ts.
// The app cannot depend on @checkpointvcs/common (see src/server/api/api-version.ts
// for why), so this pure module is duplicated here. Keep the two in sync.
