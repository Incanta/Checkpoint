...
// ─── Generated C# file for the Horde integration ────────────────────

write(
  "src/clients/horde/src/Checkpoint.Api/Version.g.cs",
...
\tpublic const string ClientVersion = ${JSON.stringify(versions.client_version)};

\t/// <summary>Server API level this client was built against.</summary>
\tpublic const int ServerApi = ${versions.server_api};
}
`,
);
